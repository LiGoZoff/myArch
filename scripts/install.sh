...
yay -S hyprpicker clipse cava google-chrome ayugram-desktop youtube-music-bin vesktop-bin yandex-music bluetuith-bin onlyoffice-bin osu ttf-font-icons ttf-ionicons hyprlock hypridle bluez bluez-utils bluez-deprecated-tools cliphist visual-studio-code-bin spotify
